= Ryan Bates Dot Files modified by Bryan Stitt
...
== Installation
  ...
  git clone git@github.com:thisbrownone/dotfiles.git ~/.dotfiles
  cd ~/.dotfiles
  rake install
...
Unlike Ryan, I stick to bash


== Features

There are some scripts in ~/.bin that are simple enough.
